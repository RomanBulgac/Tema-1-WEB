...
//$userPage = new UserReg($_GET['id'], $conn);
if (isset($_COOKIE['rememberMe'])) {
    ...
    if (isset($_GET['id'])) {
        if (article::exists($conn, $_GET['id'])) {
            $article = new article($_GET['id'], $conn);
            $usr = new UserReg($article->author, $conn);
        } else {
    ...
    <body>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="post-heading">
                            ...
                            <span class="meta">
                                Posted by
                                <a href="user.php?id=<?php echo $usr->id ?>"><?php echo $usr->username; ?></a>
                                on <?php echo utils::getDateFormat($article->date); ?>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <article class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <?php echo article::readFile($article->id); ?>
                    </div>
                </div>
            </div>
        </article>
